...
from aircall_mcp.server import mcp
...
TOOLKIT = ToolkitConfig(
    ...
    source_path=_TESTS_DIR.parent / "aircall_mcp",
    module_path="aircall_mcp",
    server_path=_TESTS_DIR.parent / "aircall_mcp" / "server.py",
    resilience=ResilienceConfig(tools_to_timeout_test=["get_company"]),
    skip_tiers={
        "contract": "no published OpenAPI spec for Aircall API",
